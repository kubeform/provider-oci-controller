...
// +kubebuilder:rbac:groups=apigateway.oci.kubeform.com,resources=deployments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apigateway.oci.kubeform.com,resources=deployments/status,verbs=get;update;patch
