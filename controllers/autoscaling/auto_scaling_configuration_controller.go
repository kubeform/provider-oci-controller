...
// +kubebuilder:rbac:groups=autoscaling.oci.kubeform.com,resources=autoscalingconfigurations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=autoscaling.oci.kubeform.com,resources=autoscalingconfigurations/status,verbs=get;update;patch
...
func (r *AutoScalingConfigurationReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &autoscalingv1alpha1.AutoScalingConfiguration{}); err != nil {
			klog.Error(err, "unable to set up auditor", autoscalingv1alpha1.AutoScalingConfiguration{}.APIVersion, autoscalingv1alpha1.AutoScalingConfiguration{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&autoscalingv1alpha1.AutoScalingConfiguration{}).
