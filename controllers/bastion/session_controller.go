...
// +kubebuilder:rbac:groups=bastion.oci.kubeform.com,resources=sessions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bastion.oci.kubeform.com,resources=sessions/status,verbs=get;update;patch
...
func (r *SessionReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch Session")
...
func (r *SessionReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &bastionv1alpha1.Session{}); err != nil {
			klog.Error(err, "unable to set up auditor", bastionv1alpha1.Session{}.APIVersion, bastionv1alpha1.Session{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&bastionv1alpha1.Session{}).
