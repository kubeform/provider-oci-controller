...
// +kubebuilder:rbac:groups=blockchain.oci.kubeform.com,resources=peers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=blockchain.oci.kubeform.com,resources=peers/status,verbs=get;update;patch
...
func (r *PeerReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &blockchainv1alpha1.Peer{}); err != nil {
			klog.Error(err, "unable to set up auditor", blockchainv1alpha1.Peer{}.APIVersion, blockchainv1alpha1.Peer{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&blockchainv1alpha1.Peer{}).
