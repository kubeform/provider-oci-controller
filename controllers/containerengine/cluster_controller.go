...
// +kubebuilder:rbac:groups=containerengine.oci.kubeform.com,resources=clusters,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=containerengine.oci.kubeform.com,resources=clusters/status,verbs=get;update;patch
...
func (r *ClusterReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &containerenginev1alpha1.Cluster{}); err != nil {
			klog.Error(err, "unable to set up auditor", containerenginev1alpha1.Cluster{}.APIVersion, containerenginev1alpha1.Cluster{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&containerenginev1alpha1.Cluster{}).
