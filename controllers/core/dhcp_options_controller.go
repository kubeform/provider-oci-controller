...
// +kubebuilder:rbac:groups=core.oci.kubeform.com,resources=dhcpoptions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=core.oci.kubeform.com,resources=dhcpoptions/status,verbs=get;update;patch
...
func (r *DhcpOptionsReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &corev1alpha1.DhcpOptions{}); err != nil {
			klog.Error(err, "unable to set up auditor", corev1alpha1.DhcpOptions{}.APIVersion, corev1alpha1.DhcpOptions{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&corev1alpha1.DhcpOptions{}).
