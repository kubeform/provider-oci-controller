...
// +kubebuilder:rbac:groups=core.oci.kubeform.com,resources=images,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=core.oci.kubeform.com,resources=images/status,verbs=get;update;patch
...
func (r *ImageReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &corev1alpha1.Image{}); err != nil {
			klog.Error(err, "unable to set up auditor", corev1alpha1.Image{}.APIVersion, corev1alpha1.Image{}.Kind)
			return err
		}
	}
