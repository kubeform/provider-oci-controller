...
// +kubebuilder:rbac:groups=core.oci.kubeform.com,resources=instances,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=core.oci.kubeform.com,resources=instances/status,verbs=get;update;patch
...
func (r *InstanceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &corev1alpha1.Instance{}); err != nil {
			klog.Error(err, "unable to set up auditor", corev1alpha1.Instance{}.APIVersion, corev1alpha1.Instance{}.Kind)
			return err
		}
	}
