...
// +kubebuilder:rbac:groups=core.oci.kubeform.com,resources=ipv6s,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=core.oci.kubeform.com,resources=ipv6s/status,verbs=get;update;patch
...
func (r *Ipv6Reconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &corev1alpha1.Ipv6{}); err != nil {
			klog.Error(err, "unable to set up auditor", corev1alpha1.Ipv6{}.APIVersion, corev1alpha1.Ipv6{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&corev1alpha1.Ipv6{}).
