...
// +kubebuilder:rbac:groups=core.oci.kubeform.com,resources=publicips,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=core.oci.kubeform.com,resources=publicips/status,verbs=get;update;patch
...
func (r *PublicIPReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &corev1alpha1.PublicIP{}); err != nil {
			klog.Error(err, "unable to set up auditor", corev1alpha1.PublicIP{}.APIVersion, corev1alpha1.PublicIP{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&corev1alpha1.PublicIP{}).
