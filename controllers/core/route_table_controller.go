...
// +kubebuilder:rbac:groups=core.oci.kubeform.com,resources=routetables,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=core.oci.kubeform.com,resources=routetables/status,verbs=get;update;patch
...
func (r *RouteTableReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &corev1alpha1.RouteTable{}); err != nil {
			klog.Error(err, "unable to set up auditor", corev1alpha1.RouteTable{}.APIVersion, corev1alpha1.RouteTable{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&corev1alpha1.RouteTable{}).
