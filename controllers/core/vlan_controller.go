...
// +kubebuilder:rbac:groups=core.oci.kubeform.com,resources=vlans,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=core.oci.kubeform.com,resources=vlans/status,verbs=get;update;patch
...
func (r *VlanReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &corev1alpha1.Vlan{}); err != nil {
			klog.Error(err, "unable to set up auditor", corev1alpha1.Vlan{}.APIVersion, corev1alpha1.Vlan{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&corev1alpha1.Vlan{}).
