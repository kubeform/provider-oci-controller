...
// +kubebuilder:rbac:groups=database.oci.kubeform.com,resources=backups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=database.oci.kubeform.com,resources=backups/status,verbs=get;update;patch
...
func (r *BackupReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &databasev1alpha1.Backup{}); err != nil {
			klog.Error(err, "unable to set up auditor", databasev1alpha1.Backup{}.APIVersion, databasev1alpha1.Backup{}.Kind)
			return err
		}
	}
