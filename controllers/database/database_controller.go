...
// +kubebuilder:rbac:groups=database.oci.kubeform.com,resources=databases,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=database.oci.kubeform.com,resources=databases/status,verbs=get;update;patch
