...
// +kubebuilder:rbac:groups=database.oci.kubeform.com,resources=migrations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=database.oci.kubeform.com,resources=migrations/status,verbs=get;update;patch
...
func (r *MigrationReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &databasev1alpha1.Migration{}); err != nil {
			klog.Error(err, "unable to set up auditor", databasev1alpha1.Migration{}.APIVersion, databasev1alpha1.Migration{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&databasev1alpha1.Migration{}).
