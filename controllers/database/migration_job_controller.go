...
// +kubebuilder:rbac:groups=database.oci.kubeform.com,resources=migrationjobs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=database.oci.kubeform.com,resources=migrationjobs/status,verbs=get;update;patch
...
func (r *MigrationJobReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &databasev1alpha1.MigrationJob{}); err != nil {
			klog.Error(err, "unable to set up auditor", databasev1alpha1.MigrationJob{}.APIVersion, databasev1alpha1.MigrationJob{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&databasev1alpha1.MigrationJob{}).
