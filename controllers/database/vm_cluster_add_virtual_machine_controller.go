...
// VmClusterAddVirtualMachineReconciler reconciles a VmClusterAddVirtualMachine object
type VmClusterAddVirtualMachineReconciler struct {
	client.Client
	Log    logr.Logger
...
// +kubebuilder:rbac:groups=database.oci.kubeform.com,resources=vmclusteraddvirtualmachines,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=database.oci.kubeform.com,resources=vmclusteraddvirtualmachines/status,verbs=get;update;patch

func (r *VmClusterAddVirtualMachineReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	log := r.Log.WithValues("vmclusteraddvirtualmachine", req.NamespacedName)

	var unstructuredObj unstructured.Unstructured
	unstructuredObj.SetGroupVersionKind(r.Gvk)

	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch VmClusterAddVirtualMachine")
...
func (r *VmClusterAddVirtualMachineReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &databasev1alpha1.VmClusterAddVirtualMachine{}); err != nil {
			klog.Error(err, "unable to set up auditor", databasev1alpha1.VmClusterAddVirtualMachine{}.APIVersion, databasev1alpha1.VmClusterAddVirtualMachine{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&databasev1alpha1.VmClusterAddVirtualMachine{}).
