...
// +kubebuilder:rbac:groups=datacatalog.oci.kubeform.com,resources=catalogs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=datacatalog.oci.kubeform.com,resources=catalogs/status,verbs=get;update;patch
...
func (r *CatalogReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &datacatalogv1alpha1.Catalog{}); err != nil {
			klog.Error(err, "unable to set up auditor", datacatalogv1alpha1.Catalog{}.APIVersion, datacatalogv1alpha1.Catalog{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&datacatalogv1alpha1.Catalog{}).
