...
// +kubebuilder:rbac:groups=datacatalog.oci.kubeform.com,resources=connections,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=datacatalog.oci.kubeform.com,resources=connections/status,verbs=get;update;patch
...
func (r *ConnectionReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &datacatalogv1alpha1.Connection{}); err != nil {
			klog.Error(err, "unable to set up auditor", datacatalogv1alpha1.Connection{}.APIVersion, datacatalogv1alpha1.Connection{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&datacatalogv1alpha1.Connection{}).
...
func (r *ConnectionReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		resourceList := &datacatalogv1alpha1.ConnectionList{}
