...
// +kubebuilder:rbac:groups=datascience.oci.kubeform.com,resources=jobs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=datascience.oci.kubeform.com,resources=jobs/status,verbs=get;update;patch
...
func (r *JobReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &datasciencev1alpha1.Job{}); err != nil {
			klog.Error(err, "unable to set up auditor", datasciencev1alpha1.Job{}.APIVersion, datasciencev1alpha1.Job{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&datasciencev1alpha1.Job{}).
