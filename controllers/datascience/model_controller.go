...
// +kubebuilder:rbac:groups=datascience.oci.kubeform.com,resources=models,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=datascience.oci.kubeform.com,resources=models/status,verbs=get;update;patch
...
func (r *ModelReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &datasciencev1alpha1.Model{}); err != nil {
			klog.Error(err, "unable to set up auditor", datasciencev1alpha1.Model{}.APIVersion, datasciencev1alpha1.Model{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&datasciencev1alpha1.Model{}).
