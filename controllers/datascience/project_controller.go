...
// +kubebuilder:rbac:groups=datascience.oci.kubeform.com,resources=projects,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=datascience.oci.kubeform.com,resources=projects/status,verbs=get;update;patch
...
func (r *ProjectReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &datasciencev1alpha1.Project{}); err != nil {
			klog.Error(err, "unable to set up auditor", datasciencev1alpha1.Project{}.APIVersion, datasciencev1alpha1.Project{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&datasciencev1alpha1.Project{}).
