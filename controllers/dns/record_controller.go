...
// +kubebuilder:rbac:groups=dns.oci.kubeform.com,resources=records,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=dns.oci.kubeform.com,resources=records/status,verbs=get;update;patch
