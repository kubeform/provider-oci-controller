...
// +kubebuilder:rbac:groups=dns.oci.kubeform.com,resources=resolvers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=dns.oci.kubeform.com,resources=resolvers/status,verbs=get;update;patch
...
func (r *ResolverReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &dnsv1alpha1.Resolver{}); err != nil {
			klog.Error(err, "unable to set up auditor", dnsv1alpha1.Resolver{}.APIVersion, dnsv1alpha1.Resolver{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&dnsv1alpha1.Resolver{}).
