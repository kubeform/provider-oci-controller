...
// +kubebuilder:rbac:groups=dns.oci.kubeform.com,resources=resolverendpoints,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=dns.oci.kubeform.com,resources=resolverendpoints/status,verbs=get;update;patch
...
func (r *ResolverEndpointReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &dnsv1alpha1.ResolverEndpoint{}); err != nil {
			klog.Error(err, "unable to set up auditor", dnsv1alpha1.ResolverEndpoint{}.APIVersion, dnsv1alpha1.ResolverEndpoint{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&dnsv1alpha1.ResolverEndpoint{}).
