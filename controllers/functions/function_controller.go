...
// +kubebuilder:rbac:groups=functions.oci.kubeform.com,resources=functions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=functions.oci.kubeform.com,resources=functions/status,verbs=get;update;patch
...
func (r *FunctionReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &functionsv1alpha1.Function{}); err != nil {
			klog.Error(err, "unable to set up auditor", functionsv1alpha1.Function{}.APIVersion, functionsv1alpha1.Function{}.Kind)
			return err
		}
	}
