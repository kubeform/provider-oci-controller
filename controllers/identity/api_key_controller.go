...
// +kubebuilder:rbac:groups=identity.oci.kubeform.com,resources=apikeys,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=identity.oci.kubeform.com,resources=apikeys/status,verbs=get;update;patch
...
func (r *ApiKeyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &identityv1alpha1.ApiKey{}); err != nil {
			klog.Error(err, "unable to set up auditor", identityv1alpha1.ApiKey{}.APIVersion, identityv1alpha1.ApiKey{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&identityv1alpha1.ApiKey{}).
