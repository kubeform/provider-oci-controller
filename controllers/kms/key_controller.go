...
// +kubebuilder:rbac:groups=kms.oci.kubeform.com,resources=keys,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=kms.oci.kubeform.com,resources=keys/status,verbs=get;update;patch
