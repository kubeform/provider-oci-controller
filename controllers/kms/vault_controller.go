...
// +kubebuilder:rbac:groups=kms.oci.kubeform.com,resources=vaults,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=kms.oci.kubeform.com,resources=vaults/status,verbs=get;update;patch
...
func (r *VaultReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &kmsv1alpha1.Vault{}); err != nil {
			klog.Error(err, "unable to set up auditor", kmsv1alpha1.Vault{}.APIVersion, kmsv1alpha1.Vault{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&kmsv1alpha1.Vault{}).
