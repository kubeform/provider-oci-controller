...
// +kubebuilder:rbac:groups=kms.oci.kubeform.com,resources=verifies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=kms.oci.kubeform.com,resources=verifies/status,verbs=get;update;patch
...
func (r *VerifyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &kmsv1alpha1.Verify{}); err != nil {
			klog.Error(err, "unable to set up auditor", kmsv1alpha1.Verify{}.APIVersion, kmsv1alpha1.Verify{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&kmsv1alpha1.Verify{}).
