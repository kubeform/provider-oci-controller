...
// +kubebuilder:rbac:groups=loadbalancer.oci.kubeform.com,resources=backends,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=loadbalancer.oci.kubeform.com,resources=backends/status,verbs=get;update;patch

func (r *BackendReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	log := r.Log.WithValues("backend", req.NamespacedName)
...
func (r *BackendReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &loadbalancerv1alpha1.Backend{}); err != nil {
			klog.Error(err, "unable to set up auditor", loadbalancerv1alpha1.Backend{}.APIVersion, loadbalancerv1alpha1.Backend{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&loadbalancerv1alpha1.Backend{}).
