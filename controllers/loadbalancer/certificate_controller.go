...
// +kubebuilder:rbac:groups=loadbalancer.oci.kubeform.com,resources=certificates,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=loadbalancer.oci.kubeform.com,resources=certificates/status,verbs=get;update;patch
...
func (r *CertificateReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &loadbalancerv1alpha1.Certificate{}); err != nil {
			klog.Error(err, "unable to set up auditor", loadbalancerv1alpha1.Certificate{}.APIVersion, loadbalancerv1alpha1.Certificate{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&loadbalancerv1alpha1.Certificate{}).
...
func (r *CertificateReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		resourceList := &loadbalancerv1alpha1.CertificateList{}
