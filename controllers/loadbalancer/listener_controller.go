...
// +kubebuilder:rbac:groups=loadbalancer.oci.kubeform.com,resources=listeners,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=loadbalancer.oci.kubeform.com,resources=listeners/status,verbs=get;update;patch
...
func (r *ListenerReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &loadbalancerv1alpha1.Listener{}); err != nil {
			klog.Error(err, "unable to set up auditor", loadbalancerv1alpha1.Listener{}.APIVersion, loadbalancerv1alpha1.Listener{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&loadbalancerv1alpha1.Listener{}).
