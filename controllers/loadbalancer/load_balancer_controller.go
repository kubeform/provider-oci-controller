...
// +kubebuilder:rbac:groups=loadbalancer.oci.kubeform.com,resources=loadbalancers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=loadbalancer.oci.kubeform.com,resources=loadbalancers/status,verbs=get;update;patch
