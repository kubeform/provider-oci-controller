...
// LoadBalancerRoutingPolicyReconciler reconciles a LoadBalancerRoutingPolicy object
type LoadBalancerRoutingPolicyReconciler struct {
	client.Client
	Log    logr.Logger
...
// +kubebuilder:rbac:groups=loadbalancer.oci.kubeform.com,resources=loadbalancerroutingpolicies/status,verbs=get;update;patch
...
func (r *LoadBalancerRoutingPolicyReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch LoadBalancerRoutingPolicy")
...
func (r *LoadBalancerRoutingPolicyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	...
	return ctrl.NewControllerManagedBy(mgr).
		For(&loadbalancerv1alpha1.LoadBalancerRoutingPolicy{}).
