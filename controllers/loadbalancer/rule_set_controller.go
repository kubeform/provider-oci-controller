...
// +kubebuilder:rbac:groups=loadbalancer.oci.kubeform.com,resources=rulesets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=loadbalancer.oci.kubeform.com,resources=rulesets/status,verbs=get;update;patch
...
func (r *RuleSetReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &loadbalancerv1alpha1.RuleSet{}); err != nil {
			klog.Error(err, "unable to set up auditor", loadbalancerv1alpha1.RuleSet{}.APIVersion, loadbalancerv1alpha1.RuleSet{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&loadbalancerv1alpha1.RuleSet{}).
