...
// +kubebuilder:rbac:groups=logging.oci.kubeform.com,resources=logs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=logging.oci.kubeform.com,resources=logs/status,verbs=get;update;patch
...
func (r *LogReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &loggingv1alpha1.Log{}); err != nil {
			klog.Error(err, "unable to set up auditor", loggingv1alpha1.Log{}.APIVersion, loggingv1alpha1.Log{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&loggingv1alpha1.Log{}).
