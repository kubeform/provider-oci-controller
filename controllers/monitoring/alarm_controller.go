...
// +kubebuilder:rbac:groups=monitoring.oci.kubeform.com,resources=alarms,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=monitoring.oci.kubeform.com,resources=alarms/status,verbs=get;update;patch
...
func (r *AlarmReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &monitoringv1alpha1.Alarm{}); err != nil {
			klog.Error(err, "unable to set up auditor", monitoringv1alpha1.Alarm{}.APIVersion, monitoringv1alpha1.Alarm{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&monitoringv1alpha1.Alarm{}).
