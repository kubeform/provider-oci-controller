...
// AnalyticsClusterReconciler reconciles a AnalyticsCluster object
...
// +kubebuilder:rbac:groups=mysql.oci.kubeform.com,resources=analyticsclusters,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=mysql.oci.kubeform.com,resources=analyticsclusters/status,verbs=get;update;patch
...
func (r *AnalyticsClusterReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch AnalyticsCluster")
...
func (r *AnalyticsClusterReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &mysqlv1alpha1.AnalyticsCluster{}); err != nil {
			klog.Error(err, "unable to set up auditor", mysqlv1alpha1.AnalyticsCluster{}.APIVersion, mysqlv1alpha1.AnalyticsCluster{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&mysqlv1alpha1.AnalyticsCluster{}).
