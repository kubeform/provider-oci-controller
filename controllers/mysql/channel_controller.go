...
// +kubebuilder:rbac:groups=mysql.oci.kubeform.com,resources=channels,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=mysql.oci.kubeform.com,resources=channels/status,verbs=get;update;patch
...
func (r *ChannelReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &mysqlv1alpha1.Channel{}); err != nil {
			klog.Error(err, "unable to set up auditor", mysqlv1alpha1.Channel{}.APIVersion, mysqlv1alpha1.Channel{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&mysqlv1alpha1.Channel{}).
...
func (r *ChannelReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		resourceList := &mysqlv1alpha1.ChannelList{}
