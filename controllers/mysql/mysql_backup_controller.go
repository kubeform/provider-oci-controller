...
// +kubebuilder:rbac:groups=mysql.oci.kubeform.com,resources=mysqlbackups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=mysql.oci.kubeform.com,resources=mysqlbackups/status,verbs=get;update;patch
...
func (r *MysqlBackupReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &mysqlv1alpha1.MysqlBackup{}); err != nil {
			klog.Error(err, "unable to set up auditor", mysqlv1alpha1.MysqlBackup{}.APIVersion, mysqlv1alpha1.MysqlBackup{}.Kind)
			return err
		}
	}
