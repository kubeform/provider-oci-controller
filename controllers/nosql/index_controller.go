...
// +kubebuilder:rbac:groups=nosql.oci.kubeform.com,resources=indices,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=nosql.oci.kubeform.com,resources=indices/status,verbs=get;update;patch
...
func (r *IndexReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &nosqlv1alpha1.Index{}); err != nil {
			klog.Error(err, "unable to set up auditor", nosqlv1alpha1.Index{}.APIVersion, nosqlv1alpha1.Index{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&nosqlv1alpha1.Index{}).
