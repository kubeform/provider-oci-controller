...
// +kubebuilder:rbac:groups=objectstorage.oci.kubeform.com,resources=buckets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=objectstorage.oci.kubeform.com,resources=buckets/status,verbs=get;update;patch
...
func (r *BucketReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &objectstoragev1alpha1.Bucket{}); err != nil {
			klog.Error(err, "unable to set up auditor", objectstoragev1alpha1.Bucket{}.APIVersion, objectstoragev1alpha1.Bucket{}.Kind)
			return err
		}
	}
