...
// +kubebuilder:rbac:groups=objectstorage.oci.kubeform.com,resources=objects,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=objectstorage.oci.kubeform.com,resources=objects/status,verbs=get;update;patch
...
func (r *ObjectReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &objectstoragev1alpha1.Object{}); err != nil {
			klog.Error(err, "unable to set up auditor", objectstoragev1alpha1.Object{}.APIVersion, objectstoragev1alpha1.Object{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&objectstoragev1alpha1.Object{}).
