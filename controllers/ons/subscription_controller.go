...
// +kubebuilder:rbac:groups=ons.oci.kubeform.com,resources=subscriptions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ons.oci.kubeform.com,resources=subscriptions/status,verbs=get;update;patch
...
func (r *SubscriptionReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &onsv1alpha1.Subscription{}); err != nil {
			klog.Error(err, "unable to set up auditor", onsv1alpha1.Subscription{}.APIVersion, onsv1alpha1.Subscription{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&onsv1alpha1.Subscription{}).
