...
// +kubebuilder:rbac:groups=streaming.oci.kubeform.com,resources=streams,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=streaming.oci.kubeform.com,resources=streams/status,verbs=get;update;patch
...
func (r *StreamReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &streamingv1alpha1.Stream{}); err != nil {
			klog.Error(err, "unable to set up auditor", streamingv1alpha1.Stream{}.APIVersion, streamingv1alpha1.Stream{}.Kind)
			return err
		}
	}
