...
// +kubebuilder:rbac:groups=vault.oci.kubeform.com,resources=secrets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=vault.oci.kubeform.com,resources=secrets/status,verbs=get;update;patch
...
func (r *SecretReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &vaultv1alpha1.Secret{}); err != nil {
			klog.Error(err, "unable to set up auditor", vaultv1alpha1.Secret{}.APIVersion, vaultv1alpha1.Secret{}.Kind)
			return err
		}
	}
