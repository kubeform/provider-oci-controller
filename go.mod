module kubeform.dev/provider-oci-controller
...
require (
	...
	kubeform.dev/provider-oci-api v0.4.1-0.20220309072008-7da3cdc363d6
...
require (
	...
	github.com/oracle/oci-go-sdk/v50 v50.0.0 // indirect
