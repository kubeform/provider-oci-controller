...
import (
	...
	ocischeme "kubeform.dev/provider-oci-api/client/clientset/versioned/scheme"
...
func init() {
	_ = ocischeme.AddToScheme(scheme)
...
func NewCmdRun(version string) *cobra.Command {
	cmd := &cobra.Command{
		Use:               "run",
		Short:             "Launch Kubeform oci Provider controller",
		DisableAutoGenTag: true,
		Run: func(cmd *cobra.Command, args []string) {
			klog.Infoln("Starting provider-oci-controller...")
			...
			mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
				...
				LeaderElectionID:       "oci.kubeform.com",
			})
			if err != nil {
