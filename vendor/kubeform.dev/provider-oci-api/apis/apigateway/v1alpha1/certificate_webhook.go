...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-apigateway-oci-kubeform-com-v1alpha1-certificate,mutating=false,failurePolicy=fail,groups=apigateway.oci.kubeform.com,resources=certificates,versions=v1alpha1,name=certificate.apigateway.oci.kubeform.io,sideEffects=None,admissionReviewVersions=v1

var _ webhook.Validator = &Certificate{}

var certificateForceNewList = map[string]bool{
	"/certificate":               true,
	"/intermediate_certificates": true,
}
