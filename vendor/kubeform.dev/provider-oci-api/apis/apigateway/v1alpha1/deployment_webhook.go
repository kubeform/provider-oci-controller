...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-apigateway-oci-kubeform-com-v1alpha1-deployment,mutating=false,failurePolicy=fail,groups=apigateway.oci.kubeform.com,resources=deployments,versions=v1alpha1,name=deployment.apigateway.oci.kubeform.io,sideEffects=None,admissionReviewVersions=v1
