...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-audit-oci-kubeform-com-v1alpha1-configuration,mutating=false,failurePolicy=fail,groups=audit.oci.kubeform.com,resources=configurations,versions=v1alpha1,name=configuration.audit.oci.kubeform.io,sideEffects=None,admissionReviewVersions=v1
