...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-database-oci-kubeform-com-v1alpha1-dbhome,mutating=false,failurePolicy=fail,groups=database.oci.kubeform.com,resources=dbhomes,versions=v1alpha1,name=dbhome.database.oci.kubeform.io,sideEffects=None,admissionReviewVersions=v1
...
func (r *DbHome) ValidateDelete() error {
	if r.Spec.TerminationPolicy == base.TerminationPolicyDoNotTerminate {
		return fmt.Errorf(`dbhome "%v/%v" can't be terminated. To delete, change spec.terminationPolicy to Delete`, r.Namespace, r.Name)
	}
	return nil
}
