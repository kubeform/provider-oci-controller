...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NotebookSessionSpecNotebookSessionConfigDetails) DeepCopyInto(out *NotebookSessionSpecNotebookSessionConfigDetails) {
	*out = *in
	if in.BlockStorageSizeInGbs != nil {
		in, out := &in.BlockStorageSizeInGbs, &out.BlockStorageSizeInGbs
		*out = new(int64)
	...
	if in.NotebookSessionShapeConfigDetails != nil {
		...
		*out = new(NotebookSessionSpecNotebookSessionConfigDetailsNotebookSessionShapeConfigDetails)
		(*in).DeepCopyInto(*out)
	}
	if in.Shape != nil {
...
func (in *NotebookSessionSpecNotebookSessionConfigDetails) DeepCopy() *NotebookSessionSpecNotebookSessionConfigDetails {
	if in == nil {
		return nil
	}
	out := new(NotebookSessionSpecNotebookSessionConfigDetails)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NotebookSessionSpecNotebookSessionConfigDetailsNotebookSessionShapeConfigDetails) DeepCopyInto(out *NotebookSessionSpecNotebookSessionConfigDetailsNotebookSessionShapeConfigDetails) {
	*out = *in
...
func (in *NotebookSessionSpecNotebookSessionConfigDetailsNotebookSessionShapeConfigDetails) DeepCopy() *NotebookSessionSpecNotebookSessionConfigDetailsNotebookSessionShapeConfigDetails {
	if in == nil {
		return nil
	}
	out := new(NotebookSessionSpecNotebookSessionConfigDetailsNotebookSessionShapeConfigDetails)
