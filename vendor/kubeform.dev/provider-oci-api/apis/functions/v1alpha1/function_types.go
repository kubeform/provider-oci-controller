...
type FunctionSpecTraceConfig struct {
	// +optional
...
type FunctionSpecResource struct {
	...
	MemoryInMbs    *string `json:"memoryInMbs" tf:"memory_in_mbs"`
	// +optional
	...
	// +optional
	TraceConfig *FunctionSpecTraceConfig `json:"traceConfig,omitempty" tf:"trace_config"`
}
