...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-identity-oci-kubeform-com-v1alpha1-domain,mutating=false,failurePolicy=fail,groups=identity.oci.kubeform.com,resources=domains,versions=v1alpha1,name=domain.identity.oci.kubeform.io,sideEffects=None,admissionReviewVersions=v1
