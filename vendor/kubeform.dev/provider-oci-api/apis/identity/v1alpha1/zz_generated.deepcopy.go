...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DataPlaneGenerateScopedAccessToken) DeepCopyInto(out *DataPlaneGenerateScopedAccessToken) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
func (in *DataPlaneGenerateScopedAccessToken) DeepCopy() *DataPlaneGenerateScopedAccessToken {
	if in == nil {
		return nil
	}
	out := new(DataPlaneGenerateScopedAccessToken)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DataPlaneGenerateScopedAccessTokenList) DeepCopyInto(out *DataPlaneGenerateScopedAccessTokenList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]DataPlaneGenerateScopedAccessToken, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *DataPlaneGenerateScopedAccessTokenList) DeepCopy() *DataPlaneGenerateScopedAccessTokenList {
	if in == nil {
		return nil
	}
	out := new(DataPlaneGenerateScopedAccessTokenList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *DataPlaneGenerateScopedAccessTokenList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DataPlaneGenerateScopedAccessTokenSpec) DeepCopyInto(out *DataPlaneGenerateScopedAccessTokenSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(DataPlaneGenerateScopedAccessTokenSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *DataPlaneGenerateScopedAccessTokenSpec) DeepCopy() *DataPlaneGenerateScopedAccessTokenSpec {
	if in == nil {
		return nil
	}
	out := new(DataPlaneGenerateScopedAccessTokenSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DataPlaneGenerateScopedAccessTokenSpecResource) DeepCopyInto(out *DataPlaneGenerateScopedAccessTokenSpecResource) {
	*out = *in
	if in.Timeouts != nil {
		in, out := &in.Timeouts, &out.Timeouts
		*out = new(apiv1alpha1.ResourceTimeout)
...
func (in *DataPlaneGenerateScopedAccessTokenSpecResource) DeepCopy() *DataPlaneGenerateScopedAccessTokenSpecResource {
	if in == nil {
		return nil
	}
	out := new(DataPlaneGenerateScopedAccessTokenSpecResource)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DataPlaneGenerateScopedAccessTokenStatus) DeepCopyInto(out *DataPlaneGenerateScopedAccessTokenStatus) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make([]apiv1.Condition, len(*in))
...
func (in *DataPlaneGenerateScopedAccessTokenStatus) DeepCopy() *DataPlaneGenerateScopedAccessTokenStatus {
	if in == nil {
		return nil
	}
	out := new(DataPlaneGenerateScopedAccessTokenStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DbCredentialSpec) DeepCopyInto(out *DbCredentialSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(DbCredentialSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *DbCredentialSpecResource) DeepCopy() *DbCredentialSpecResource {
	if in == nil {
		return nil
	}
	out := new(DbCredentialSpecResource)
...
func (in *DomainReplicationToRegionSpec) DeepCopyInto(out *DomainReplicationToRegionSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(DomainReplicationToRegionSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DomainReplicationToRegionSpecResource) DeepCopyInto(out *DomainReplicationToRegionSpecResource) {
	*out = *in
	if in.Timeouts != nil {
		in, out := &in.Timeouts, &out.Timeouts
		*out = new(apiv1alpha1.ResourceTimeout)
...
func (in *DomainReplicationToRegionSpecResource) DeepCopy() *DomainReplicationToRegionSpecResource {
	if in == nil {
		return nil
	}
	out := new(DomainReplicationToRegionSpecResource)
...
func (in *DomainSpecReplicaRegions) DeepCopy() *DomainSpecReplicaRegions {
	if in == nil {
		return nil
	}
	out := new(DomainSpecReplicaRegions)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DomainSpecResource) DeepCopyInto(out *DomainSpecResource) {
	*out = *in
	...
	if in.ReplicaRegions != nil {
		...
		*out = make([]DomainSpecReplicaRegions, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ImportStandardTagsManagementSpec) DeepCopyInto(out *ImportStandardTagsManagementSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(ImportStandardTagsManagementSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ImportStandardTagsManagementSpecResource) DeepCopyInto(out *ImportStandardTagsManagementSpecResource) {
	*out = *in
	if in.Timeouts != nil {
		in, out := &in.Timeouts, &out.Timeouts
		*out = new(apiv1alpha1.ResourceTimeout)
...
func (in *ImportStandardTagsManagementSpecResource) DeepCopy() *ImportStandardTagsManagementSpecResource {
	if in == nil {
		return nil
	}
	out := new(ImportStandardTagsManagementSpecResource)
