...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-jms-oci-kubeform-com-v1alpha1-fleet,mutating=false,failurePolicy=fail,groups=jms.oci.kubeform.com,resources=fleet,versions=v1alpha1,name=fleet.jms.oci.kubeform.io,sideEffects=None,admissionReviewVersions=v1
