...
type BalancerBackend struct {
	...
	Spec              BalancerBackendSpec   `json:"spec,omitempty"`
	Status            BalancerBackendStatus `json:"status,omitempty"`
}

type BalancerBackendSpec struct {
	State *BalancerBackendSpecResource `json:"state,omitempty" tf:"-"`

	Resource BalancerBackendSpecResource `json:"resource" tf:"resource"`
...
type BalancerBackendSpecResource struct {
...
// BalancerBackendList is a list of BalancerBackends
type BalancerBackendList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	// Items is a list of BalancerBackend CRD objects
	Items []BalancerBackend `json:"items,omitempty"`
}
