...
type BalancerRuleSet struct {
	...
	Spec              BalancerRuleSetSpec   `json:"spec,omitempty"`
	Status            BalancerRuleSetStatus `json:"status,omitempty"`
}

type BalancerRuleSetSpecItemsConditions struct {
...
type BalancerRuleSetSpecItemsRedirectURI struct {
	// +optional
...
type BalancerRuleSetSpecItems struct {
	...
	// +optional
	Conditions []BalancerRuleSetSpecItemsConditions `json:"conditions,omitempty" tf:"conditions"`
	// +optional
	...
	// +optional
	RedirectURI *BalancerRuleSetSpecItemsRedirectURI `json:"redirectURI,omitempty" tf:"redirect_uri"`
	// +optional
...
type BalancerRuleSetSpec struct {
	State *BalancerRuleSetSpecResource `json:"state,omitempty" tf:"-"`

	Resource BalancerRuleSetSpecResource `json:"resource" tf:"resource"`
...
type BalancerRuleSetSpecResource struct {
	Timeouts *base.ResourceTimeout `json:"timeouts,omitempty" tf:"timeouts"`

	ID string `json:"id,omitempty" tf:"id,omitempty"`

	Items          []BalancerRuleSetSpecItems `json:"items" tf:"items"`
...
// BalancerRuleSetList is a list of BalancerRuleSets
type BalancerRuleSetList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	// Items is a list of BalancerRuleSet CRD objects
	Items []BalancerRuleSet `json:"items,omitempty"`
}
