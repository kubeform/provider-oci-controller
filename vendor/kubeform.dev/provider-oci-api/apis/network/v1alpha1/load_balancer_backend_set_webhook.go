...
var loadbalancerbackendsetForceNewList = map[string]bool{
	"/name":                     true,
...
func (r *LoadBalancerBackendSet) ValidateUpdate(old runtime.Object) error {
	...
	res := old.(*LoadBalancerBackendSet)
	...
	for key := range loadbalancerbackendsetForceNewList {
		...
		if checkIfAnyDif && r.Spec.UpdatePolicy == base.UpdatePolicyDoNotDestroy {
			return fmt.Errorf(`loadbalancerbackendset "%v/%v" immutable field can't be updated. To update, change spec.updatePolicy to Destroy`, r.Namespace, r.Name)
		}
	}
	return nil
}
