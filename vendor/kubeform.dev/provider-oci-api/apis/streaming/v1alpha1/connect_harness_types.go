...
type ConnectHarnessSpec struct {
	State *ConnectHarnessSpecResource `json:"state,omitempty" tf:"-"`

	Resource ConnectHarnessSpecResource `json:"resource" tf:"resource"`
...
type ConnectHarnessSpecResource struct {
...
type ConnectHarnessList struct {
	...
	// Items is a list of ConnectHarness CRD objects
	Items []ConnectHarness `json:"items,omitempty"`
}
